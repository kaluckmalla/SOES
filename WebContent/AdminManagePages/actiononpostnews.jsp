...
<title>Action on Post News</title>
...
<form method="post" action="/SOES/SearchNewsByIdServlet">

		<div class="container-fluid d-flex justify-content-center"
			style="background-color: #ECECEC;">
			<div class="row col-sm-10 d-flex justify-content-center">
				<h2 class="text-center text-white bg-danger">SEARCH NEWS BY ID</h2>
				
				<input class="col-7 col-sm-4" type="number" name="searchnewsid"
...
<form method="post" action="/SOES/ActionOnNewsServlet"
		...
		<div class="container-fluid d-flex justify-content-center" style="background-color: #ECECEC;">
			<div class="row col-12  col-sm-10">
				...
				<div class=" mb-2 col-6 col-sm-6"id="hide1">
					...
					<input  class="h6"type="number" name="snewsId" value="${snId}"
				...
				<div class="mb-2" id="hide2">
					<h5 class="text-primary">${snHeadsnImage}</h5>

					<textarea class="h6" name="snImageNameFromDB" 
						id="inputfieldForFileName" required readonly style="width:100%; " >${snImage}</textarea>
				</div>
	...
	<div class="container-fluid d-flex justify-content-center" style="background-color: #ECECEC;">
			...
			<h2 class="text-center text-white bg-danger mt-3">NEWS LIST</h2>
...
<table class="table-bordered text-center  text-break">
		...
		try {
			...
			for (AddPostNewsClass actionnewspage : newspostlist) {
		%>
		<tr style="background-color: #F5F5DC;height:3rem;">

			<td class="h6 fw-normal" width="50rem"><%=actionnewspage.getpId()%></td>
			<td class="h6 fw-normal" width="50rem"><%=actionnewspage.getpDate()%></td>
			<td class="title h6  text-break"><a href="<%=request.getContextPath()%>/NewsView?newsId=<%=actionnewspage.getpId()%>"><%=actionnewspage.getpTitle()%></a></td>
			<td class="image h6  text-break"><a href="/SOES/uploads/news/<%=actionnewspage.getpImage()%>"><%=actionnewspage.getpImage()%></a></td>
		</tr>
