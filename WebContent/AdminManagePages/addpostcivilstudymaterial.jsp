...
<title>Add Civil Material</title>
...
<body>
	<form method="post" action="/SOES/AddPostCivilStudyMaterial" enctype="multipart/form-data">
		<div class="container-fluid d-flex justify-content-center" style="background-color:lightblue;">
			<div class="row col-sm-8">
<h2 class="mt-2 mb-2 text-center" style="color: darkblue; ">Add and Post Civil Engineering Material</h2>
		...
		<hr style="height: .1rem;color:darkblue; opacity: 5">
					...
					<label class="h3 mb-3" style="color: blue;">Faculty </label><label> <input class="h4 col-10" type="text" name="spFaculty"
						value="Civil Engineering" readonly required>
