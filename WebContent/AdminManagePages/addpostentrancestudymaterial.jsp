...
<title>Add Entrance Material</title>
...
<body>
	<form method="post" action="/SOES/AddPostEntranceStudyMaterial"
		enctype="multipart/form-data">
		<div class="container-fluid d-flex justify-content-center"
			style="background-color: lightblue;">
			<div class="row col-sm-8">
				<h2 class="mt-2 mb-2 text-center" style="color: darkblue;">Add
					and Post Entrance Material</h2>
				...
				<label class="h6 text-end" style="color: red;">Date <input
					class="h6" type="text" name="entrancepostDate" value="<%=date%>"
					readonly style="width: 7rem;" required>

				</label> <label class="h6 text-end" style="color: red;">Post Id <input
					class="h6" type="number" name="entrancepostId"
					value="${incrementedPostId}" readonly style="width: 7rem;" required>

				</label> <label class="h3 mb-3" style="color: blue;">Faculty </label><label> <input class="h4 col-10" type="text"
					name="entrancepostFaculty" value="Entrance" readonly required>

				</label> <label class="h3 mb-3" style="color: blue;">Semester </label><label> <input class="h4 col-10" type="text"
					name="entrancepostSemester" value="No Semester" readonly required>

				</label> <label class="h3 mb-3" style="color: blue;">Type </label><label><select class="h4 col-10" name="entrancepostType"
					required>
				...
				</select> </label> <label class="h3 mb-3" style="color: blue;">Subject </label><label><select class="h4 col-10"
					name="entrancepostSubject" required>
				...
				</select> </label> <label class="h3 mb-3" style="color: blue;">Select your
					file</label> <input class="h5" type="file" name="entrancepostFile" required
