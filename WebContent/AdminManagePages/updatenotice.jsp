...
<h2 class="mt-2 mb-2 text-center " style="color: darkblue; ">Update Notice</h2>
		
		<hr style="height: .1rem;color:darkblue; opacity: 5">

					
				<h5 class="mt-2 mb-2 text-center fw-normal fst-italic " style="color: red; ">Note : you can update only notice title.</h5>
				
					
					<label  class="h6 text-end" style="color: red;">Published Date <input type="text" 
						value="${editDate}" readonly required>
					</label>
					<label  class="h6 text-end" style="color: red;">Notice Id <input type="number" name="snoticeId"
						value="${editId}" readonly required>

					</label>
										<label class="h3 mb-3" style="color: blue;">Title</label>
					
				<div>
					<textarea class="h4" name="editTitle" id="textarea" rows="3" maxlength="100"
					 style="width:100%;">${editTitle}</textarea>
